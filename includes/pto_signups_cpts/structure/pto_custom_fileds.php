        				...
        				<li class="ui-state-default" id="<?php echo intval( $cpt_custom_filed ); ?>">
            				<div class="pto-signup-custom-fileds-ul-li_div">
              					...
              					<div class="hook-action">
									<span><a href="javascript:void(window.open('<?php echo esc_url( site_url() )."/wp-admin/post.php?post=".intval( $cpt_custom_filed )."&action=edit"; ?>'))"> Edit</a> <span class="pto-separator">|</span> </span>
									<span><a href="javascript:void(0)" id="single-custom_filed_delete" cpt-ids="<?php echo intval( $cpt_custom_filed ); ?>"> Delete</a> <span class="pto-separator">|</span> </span>
                					<?php
    	...
    	jQuery( '#sortable' ).sortable({
        	update: function( event, ui ) {
				...
				jQuery.ajax({
					...
					data:{
						action:'pto_signup_custom_fields_checkouts',
